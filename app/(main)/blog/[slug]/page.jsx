  ...
  return (
    <section className="w-full py-16 px-6 md:px-20 bg-white">
      <div className="max-w-4xl mx-auto">
        <Link href="/blogs" className="text-sm text-gray-500 hover:underline">← Back to Blogs</Link>
        ...
        <article className="prose max-w-none prose-red text-gray-800 mb-10">
          {blog.content}
        </article>
        ...
        {related.length > 0 && (
          <div className="mt-10">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              {related.map((item) => (
                <Link href={`/blogs/${item.slug}`} key={item.slug}>
